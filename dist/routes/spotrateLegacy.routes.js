...
router.patch('/spotrate-commodity/:adminId/:commodityId', spotrateLegacy_controller_1.updateCommodity);
router.delete('/commodities/:adminId/:commodityId', spotrateLegacy_controller_1.deleteSpotRateCommodity);
