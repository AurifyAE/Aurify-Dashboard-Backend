...
exports.updateUserCommodity =
  exports.createCommodity =
  exports.deleteUserCommodity =
  exports.addUserCommodity =
  exports.updateUserSpread =
  exports.getUserCommodity =
    void 0;
...
const sanitizeCommodityData = (commodityData = {}) =>
...
const updateUserCommodity = async (req, res) => {
  try {
    ...
    // Validate input
    if (
      !mongoose_1.default.Types.ObjectId.isValid(adminId) ||
