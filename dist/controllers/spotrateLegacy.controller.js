...
exports.getAdminDataController =
  exports.getServerController =
  exports.createCommodity =
  exports.getSpotRate =
  exports.getCommodityController =
  exports.updateSpread =
  exports.deleteSpotRateCommodity =
...
const sanitizeCommodityData = (commodity = {}) =>
  commodityFields.reduce((sanitizedData, field) => {
...
const deleteSpotRateCommodity = async (req, res, next) => {
  try {
    const adminId = req.params.adminId;
    const commodityId = req.params.commodityId;
    const result = await SpotRate_1.default.updateOne(
      { createdBy: new mongoose_1.default.Types.ObjectId(adminId) },
      { $pull: { commodities: { _id: new mongoose_1.default.Types.ObjectId(commodityId) } } }
    );
