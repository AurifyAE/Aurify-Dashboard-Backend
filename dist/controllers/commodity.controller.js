...
exports.deleteCommodity =
  exports.updateCommodity =
  exports.createCommodity =
  exports.listCommodities =
    void 0;
...
const listCommodities = async (req, res) => {
  try {
    ...
    const commodities = await Commodity_1.default
      .find({ adminId: userId })
      .sort({ createdAt: -1 })
      .lean();
    res.status(200).json({
...
const createCommodity = async (req, res) => {
  try {
    ...
    const existing = await Commodity_1.default
      .findOne({
        adminId: userId,
...
const updateCommodity = async (req, res) => {
  try {
    ...
    const doc = await Commodity_1.default.findOneAndUpdate(
