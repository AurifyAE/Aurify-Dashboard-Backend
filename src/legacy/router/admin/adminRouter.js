...
import {
  getRetailGoldRates,
  replaceRetailGoldRates,
} from "../../controllers/admin/retailGoldRateController.js";
...
// retail gold rate — one document per admin, multiple rates in `rates` array
router.get("/retail-gold-rate/:adminId", getRetailGoldRates);
router.put("/retail-gold-rate/:adminId", replaceRetailGoldRates);
