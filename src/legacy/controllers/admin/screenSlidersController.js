import {
  screenSliderHelper,
  fetchScreenSliderHelper,
  updateScreenSliderHelper,
  deleteSliderImageHelper,
} from "../../helper/admin/ScreenSliderHelper.js";
...
export const updateScreenSlider = async (req, res, next) => {
  try {
    ...
    const updatedSliders = await updateScreenSliderHelper(
      sliderId,
      adminId,
      timeout
    );
...
export const deleteSliderImage = async (req, res, next) => {
  try {
    ...
    const updatedSliders = await deleteSliderImageHelper(
      sliderId,
      imageName,
      adminId
    );
